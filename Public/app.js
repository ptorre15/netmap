...
function isTpms(s)    { return !!s && (s.brand === 'tpms' || s.wheelPosition != null); }
      ...
      <div class="stats-breakdown-box" style="margin-bottom:14px">
        ...
        <div style="display:flex;gap:8px;align-items:center;margin-top:8px">
          <input type="text" id="ota-server-url-input" value="${escAttr(settings.otaServerUrl)}"
            placeholder="https://default.url:9443" style="flex:1;padding:6px 10px;background:var(--bg2);border:1px solid var(--border);border-radius:6px;color:var(--fg);font-size:12px">
